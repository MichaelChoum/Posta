...
const file_like_proto_rawDesc = "" +
	...
	"\x06userId\x18\x03 \x01(\x03R\x06userId\"\xbc\x01\n" +
	"\x11IsThumbupResponse\x12P\n" +
	"\fuserThumbups\x18\x01 \x03(\v2,.service.IsThumbupResponse.UserThumbupsEntryR\fuserThumbups\x1aU\n" +
	"\x11UserThumbupsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x03R\x03key\x12*\n" +
	"\x05value\x18\x02 \x01(\v2\x14.service.UserThumbupR\x05value:\x028\x01\"c\n" +
	"\vUserThumbup\x12\x16\n" +
	"\x06userId\x18\x01 \x01(\x03R\x06userId\x12 \n" +
	"\vthumbupTime\x18\x02 \x01(\x03R\vthumbupTime\x12\x1a\n" +
	"\blikeType\x18\x03 \x01(\x05R\blikeType2\x88\x01\n" +
	"\x04Like\x12<\n" +
	"\aThumbup\x12\x17.service.ThumbupRequest\x1a\x18.service.ThumbupResponse\x12B\n" +
	"\tIsThumbup\x12\x19.service.IsThumbupRequest\x1a\x1a.service.IsThumbupResponseB\vZ\t./serviceb\x06proto3"
