...
type (
	userInboxModel interface {
		...
		FindOneByUserIdSenderIdArticleId(ctx context.Context, userId int64, senderId int64, articleId int64) (*UserInbox, error)
...
func (m *defaultUserInboxModel) FindOneByUserIdSenderIdArticleId(ctx context.Context, userId int64, senderId int64, articleId int64) (*UserInbox, error) {
	var resp UserInbox
