...
var (
	...
	cachePostaUserUserIdPrefix = "cache:postaUser:user:id:"
)
...
func (m *defaultUserModel) Insert(ctx context.Context, data *User) (sql.Result, error) {
	postaUserUserIdKey := fmt.Sprintf("%s%v", cachePostaUserUserIdPrefix, data.Id)
...
func (m *defaultUserModel) formatPrimary(primary any) string {
	return fmt.Sprintf("%s%v", cachePostaUserUserIdPrefix, primary)
}
